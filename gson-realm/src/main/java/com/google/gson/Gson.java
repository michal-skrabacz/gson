...
import com.google.gson.internal.bind.MethodReflectiveTypeAdapterFactory;
...
public final class Gson
{
    ...
    public Gson()
    {
        this(Excluder.DEFAULT, FieldNamingPolicy.IDENTITY,
                ...
                true, false, false, LongSerializationPolicy.DEFAULT, false,
    ...
    Gson(final Excluder excluder, final FieldNamingStrategy fieldNamingPolicy,
         ...
         LongSerializationPolicy longSerializationPolicy, boolean useGetters,
         List<TypeAdapterFactory> typeAdapterFactories)
    {
        ...
        {
            factories.add(new MethodReflectiveTypeAdapterFactory(constructorConstructor, fieldNamingPolicy, excluder));
        }
